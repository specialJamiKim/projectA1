...
INSERT INTO f_center (address, closing_time, daily_pass_price, name, open_time, phone_number)
VALUES ('부산광역시 부산진구' , '18:30' , 10000, '굿케어헬스', '09:00' , '010-1234-5678');

INSERT INTO f_center (address, closing_time, daily_pass_price, name, open_time, phone_number)
VALUES ('부산광역시 부산진구' , '20:30' , 12000, '나이스헬스', '08:300' , '010-1234-5678');

INSERT INTO f_center (address, closing_time, daily_pass_price, name, open_time, phone_number)
VALUES ('대구광역시 달서구' , '21:00' , 8000, '람보헬스', '09:00' , '010-1234-5678');

INSERT INTO f_center (address, closing_time, daily_pass_price, name, open_time, phone_number)
VALUES ('울산광역시 중구' , '23:00' , 10000, '진짜로피트니스', '07:00' , '010-1234-5678');

INSERT INTO f_center (address, closing_time, daily_pass_price, name, open_time, phone_number)
VALUES ('부산광역시 동래구' , '23:30' , 10000, '몸짱피트니스', '06:00' , '010-1234-5678');
